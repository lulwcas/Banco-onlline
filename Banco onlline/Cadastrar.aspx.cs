...
namespace Banco_onlline
{
    public partial class Cadastrar : System.Web.UI.Page
    {
        ...
        {
            con = new SqlConnection(Common.GetConnecitionString());
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            Amount, Password) values(@AccountNumber, @AccountType, @UserName, @Gender, @Email, 
            @Address, @SecurityQuestionId, @Answer, @Amount, @Password)", con);
            ...
            catch (Exception ex)
            {
                ...
                {
                    error.InnerText = "Nome de usuário já existente.";
                }
                else
                {
